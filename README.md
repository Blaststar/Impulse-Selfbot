...
<br>
<p align="center"><i>Impulse is a free open source selfbot for Guilded.gg that has an advanced command handler, and API wrapper to make your own custom commands!</i></p>
